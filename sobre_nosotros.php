...
<div class="topnav">
  ...
  <a class="active" href="sobre_nosotros.php">Sobre nosotros</a>
  <a href="sesion_cerrar.php">Cerrar sesión</a>
  <?php $usuario = $_SESSION["usuario"]; echo "<a href='perfil.php'> $usuario </a>"; ?>
</div>

<body>
<p> Esta página web está localizada en un sistema alojado en la nube de Microsoft Azure, configurado por el alumno de ASIR2 Diego Fernández Higueras.</p>
</body>
</html>
<?php
	}?>