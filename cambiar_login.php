...
<body>
<form action="cambiar_login2.php" method="get">
<div>
<p>Introduce el nombre de usuario antiguo: <input type="text" name="usuario"></p>
<p>Introduce el nuevo nombre de usuario: <input type="text" name="nuevo_usuario"></p>
