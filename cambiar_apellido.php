...
<body>
<form action="cambiar_apellido2.php" method="get">
<div>
<p>Introduce el apellido antiguo: <input type="text" name="apellido"></p>
<p>Introduce el nuevo apellido: <input type="text" name="nuevo_apellido"></p>
