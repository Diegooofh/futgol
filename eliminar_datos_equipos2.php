...
<body>
<?php
	$nombre_de_equipo = $_GET["nombre_de_equipo"];
	...
	$resultado = mysqli_query($conexion, "DELETE FROM equipos WHERE nombre_equipo = '$nombre_de_equipo'");
	if (mysqli_connect_errno()) {
	    printf("<p>Conexión fallida: %s</p>", mysqli_connect_error());
	    exit();
	}
?>
	<button onclick=window.location.href='consulta_insert_equipos.php'>Consultar tras borrar datos</button>
	<button onclick=window.location.href='eliminar_datos_equipos.php'>Volver a eliminar</button>
</body>
</html>
<?php
	}
