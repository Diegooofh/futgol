...
<?php
	...
	$resultado = mysqli_query($conexion, "INSERT INTO equipos (nombre_equipo) VALUES ('$equipo_1')");
	if (mysqli_connect_errno()) {
	    printf("<p>Conexión fallida: %s</p>", mysqli_connect_error());
	    exit();
	}
?>
	<button onclick=window.location.href='consulta_insert_equipos.php'>Consultar tras inserción</button>
	<button onclick=window.location.href='añadir_datos_equipos.php'>Volver a insertar</button>
</body>
</html>
<?php
	}
